 ...
 * 
 */
@WebServiceClient(name = "ClienteDaoImplService", targetNamespace = "http://daoImpl.ws.soap.upeu.edu.pe/", wsdlLocation = "http://localhost:3030/soap/cliente/id?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:3030/soap/cliente/id?wsdl");
